    ...
    case WM_PAINT:
        {
			...
			//별 그리기
			MoveToEx(hdc, 100, 205, NULL);//mid
			LineTo(hdc, 400, 205);//mid
			LineTo(hdc, 145, 400);//bot
			LineTo(hdc, 250, 100);//top
			LineTo(hdc, 355, 400);//bot
			LineTo(hdc, 100, 205);//mid
            EndPaint(hWnd, &ps);

			TextOut(hdc, 250, 450, L"별그리기", NULL);
        }
        break;
    case WM_DESTROY:
        PostQuitMessage(0);
